...
int Simetrico(int [][MAX], int);            /*prototipos de funcion. */
...
void main(void)
{
    ...
    while (N > MAX || N < 1); /* SE VERIFICA QUE EL TAMAÑO DEL ARREGLOS DEA VALIDO.*/
...
/* La funcion Simerico se utiliza para determinar si el arreglo bidimensional
